...
class DuModel(torch.nn.Module):
    ...
    def task_map(self) -> dict:
        ...
        return {
            ...
            # },
            "detect": {
                "model": DuDetectionModel,  # DuDetectionModel,
                "trainer": yolo.dudetect.DuDetectionTrainer,
                "validator": yolo.dudetect.DuDetectionValidator,
